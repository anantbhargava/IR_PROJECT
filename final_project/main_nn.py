...
def main_run(args):
    ...
    val_loader = nn.Loader('data/val.pkl', batch_size=12, max_word=args.max_w, word_dict_pkl=args.word_dict,hash_tag_num=args.hash_tag, handle_num=args.handle_num)
    tr_loader = nn.Loader('data/train.pkl', batch_size=12, max_word=args.max_w, word_dict_pkl=args.word_dict,hash_tag_num=args.hash_tag, handle_num=args.handle_num)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-num_tweets", type=int, default=503, help='Number of tweets allowed in the network')
